...
import com.cloudcraftgaming.discal.module.announcement.AnnouncementQueueMainTimer;
...
public class AnnouncementQueueManager {
	...
	public ArrayList<AnnouncementQueueItem> queue = new ArrayList<>();
	...
	public void init() {
		timer = new Timer();
		//Start main queue
		timer.schedule(new AnnouncementQueueMainTimer(), 1000 * 60, 1000 * 60);
