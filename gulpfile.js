...
gulp.task('vendor', gulp.series(function(done) {
    ...
    gulp.src([
        ...
        .pipe(gulp.dest('./web/src/main/html/static/vendor/simple-line-icons/fonts'));
...
gulp.task('css:compile', gulp.series(function () {
	return gulp.src('./web/src/main/less/**/*.scss')
        ...
        .pipe(gulp.dest('./web/src/main/html/static/assets/css'))
}));

// Minify CSS
gulp.task('css:minify', gulp.series(['css:compile'], function () {
    return gulp.src([
        './web/src/main/html/static/assets/css/*.css',
        '!./web/src/main/html/static/assets/css/*.min.css'
    ])
        .pipe(cleanCSS())
        .pipe(rename({
            suffix: '.min'
